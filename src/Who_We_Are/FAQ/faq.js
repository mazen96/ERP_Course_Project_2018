    ...
    componentWillMount() {
        this.setState({
            header: 
                ...
                FAQs: 
                [
                    {id:1,question:"We strive for excellence in all that we do ?" , answer:"The Central Intelligence Agency's primary mission is to collect, evaluate, and disseminate foreign intelligence to assist the president and senior US government policymakers in making decisions relating to the national security. The CIA does not make policy; it is an independent source of foreign intelligence information for those who do. The CIA may also engage in covert action at the president's direction in accordance with applicable law."},
                    {id:2,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:3,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:4,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:5,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:6,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:7,question:"We strive for excellence in all that we do ?" , answer:""},
                    {id:8,question:"We strive for excellence in all that we do ?" , answer:""}
                ]
